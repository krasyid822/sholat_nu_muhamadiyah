        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      if (settings.locationMode == LocationMode.preset)
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (city) {
                            if (city != null) {
                              ref.read(settingsProvider.notifier).setSelectedCity(city);
                            }
                          },
                        ),
              ...
              // CARD 4: DISPLAY ACTIVE CONFIG INFO
              Container(
                      ...
                      settings.locationMode == LocationMode.preset
                          ...
                          : settings.locationMode == LocationMode.gps
                              ? (settings.gpsLatitude != null
                                  ? 'Auto GPS (${settings.gpsLatitude!.toStringAsFixed(4)}, ${settings.gpsLongitude!.toStringAsFixed(4)})'
