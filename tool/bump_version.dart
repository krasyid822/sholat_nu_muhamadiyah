...
void main() {
  ...
  if (pubspecFile.existsSync()) {
    ...
    if (match != null) {
      ...
      // Update lib/config/app_version.dart dynamically
      final versionFile = File('lib/config/app_version.dart');
      versionFile.writeAsStringSync('''// Generated by tool/bump_version.dart. Do not modify.
const String kAppVersion = '$ver+$nextBuild';
''');
      print('✅ lib/config/app_version.dart updated: $ver+$nextBuild');
    }
  }
